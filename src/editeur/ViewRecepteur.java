...
public class ViewRecepteur extends JFrame implements WindowListener {
	...
	//Logger logger = Logger.getLogger(ViewRecepteur.class.getName());
	...
	static JButton square = new JButton(new ImageIcon("images/carr�.jpg"));
	...
	public DrawPanelReception drawPanel = null;

	private boolean isLaunched;

	public ViewRecepteur() {
	...
	public DrawPanelReception getDrawPanel() {
		if (drawPanel == null)
			drawPanel = new DrawPanelReception();
		return drawPanel;
	}

	public void setDrawPanel(DrawPanelReception drawPanel) {
